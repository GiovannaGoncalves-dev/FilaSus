...
public class AuthUtil {
    ...
    /**
     * Verifica se o usuário logado na sessão possui ao menos um dos perfis fornecidos.
     *
     * @param request Requisição HTTP
     * @param perfis Lista de perfis permitidos
     * @return true se possui algum dos perfis, false caso contrário.
    ...
    /**
     * Verifica se o usuário é Administrador Geral (ADM_GERAL).
     */
    ...
    /**
     * Verifica se o usuário é Administrador de Unidade (ADM_UNIDADE).
     */
    ...
    /**
     * Verifica se o usuário é Administrador Geral ou Administrador de Unidade.
     */
    ...
    /**
     * Verifica se o usuário informado tem permissão para cadastrar/editar/gerenciar Unidades de Saúde.
     * Restrito a Administrador Geral (ADM_GERAL).
     *
     * @param usuario Usuário a ser verificado
     * @return true se o usuário pode gerenciar unidades, false caso contrário.
     */
    ...
    /**
     * Verifica se o usuário logado tem permissão para gerenciar Unidades de Saúde.
     * Restrito a Administrador Geral (ADM_GERAL).
     *
     * @param request Requisição HTTP
     * @return true se o usuário logado pode gerenciar unidades, false caso contrário.
     */
    ...
    /**
     * Verifica se o usuário informado tem permissão para cadastrar/editar/gerenciar usuários da equipe.
     * Perfis autorizados: ADM_GERAL e ADM_UNIDADE.
     *
     * @param usuario Usuário a ser verificado
     * @return true se o usuário pode gerenciar a equipe, false caso contrário.
     */
    ...
    /**
     * Verifica se o usuário logado na requisição tem permissão para cadastrar/editar/gerenciar usuários da equipe.
     *
     * @param request Requisição HTTP
     * @return true se o usuário logado pode gerenciar a equipe, false caso contrário.
     */
